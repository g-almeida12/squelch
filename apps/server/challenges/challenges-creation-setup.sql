...
(title, validation_query, difficulty, group_slug, markdown) VALUES 
(
  'Quem é o Culpado?', 
...
(
  ...
  <ul>
    <li>"Eu enviei uma mensagem para o mandante exatamente às 18:35 do dia do crime confirmando a fuga."</li>
    <li>"O mandante trabalha na sala onde fica exposta alguma obra de ''Leonardo da Vinci''."</li>
    <li>"Eu vi o mandante saindo do museu logo depois da minha mensagem. Ele dirige um carro Prata."</li>
  </ul>
  <p>
